...
namespace UniEvent
{
    ...
    public partial class BuiltinContainerBuilder
    {
        ...
        public BuiltinContainerBuilder AddBrokerFilter<T>() where T : class, IBrokerHandlerFilter
        {
            TryAddTransient<T>();
            return this;
        }
